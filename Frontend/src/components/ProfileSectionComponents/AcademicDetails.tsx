  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-8 gap-4 items-center">
        ...
        <div className="md:col-span-3 col-span-1">
          <DatePickerDemo onDateChange={(date) => handleChange("graduationDate", date)} />
        </div>
        ...
        <div>
          <ComboBoxBranch onChange={(value: string) => handleChange("branch", value)} />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 items-center gap-4 md:grid-cols-8">
        ...
        <div className="col-span-2 text-right md:text-left md:col-span-3">
          <ComboBoxYear onChange={(value) => handleChange("yearOfStudy", value)} />
        </div>
        ...
        <Input
          ...
          placeholder="Pedro@example.com"
          className="col-span-3"
          value={academicData.collegeEmail}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-8 items-center gap-4">
        ...
        <Input
          ...
          placeholder="Enter CGPA"
          className="col-span-3"
          value={academicData.aggregateCGPA}
          onChange={(e) => handleChange("aggregateCGPA", e.target.value)}
        />
      </div>
